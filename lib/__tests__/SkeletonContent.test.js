...
describe('SkeletonComponent test suite', () => {
    it('should render empty alone', () => {
        const tree = react_test_renderer_1.create(<SkeletonContent_1.default isLoading={false}/>).toJSON();
    ...
    it('should have the correct layout when loading', () => {
        ...
        const instance = react_test_renderer_1.create(<SkeletonContent_1.default {...props}/>);
    ...
    it('should render the correct bones for children', () => {
        ...
        const instance = react_test_renderer_1.create(<TestComponent {...props}/>);
        let component = instance.root;
        // finding children count
        let bones = component.findAllByType(react_native_linear_gradient_1.default);
    ...
    it('should have correct props and layout between loading states', () => {
        ...
        bones = instance.root.findAllByType(react_native_linear_gradient_1.default);
    ...
    it('should have the correct gradient properties', () => {
        ...
        const component = react_test_renderer_1.create(<TestComponent {...customProps}/>);
        let gradient = component.root.findByType(react_native_linear_gradient_1.default);
        ...
        gradient = component.root.findByType(react_native_linear_gradient_1.default);
        expect(gradient).toBeDefined();
        expect(gradient.props.start).toEqual({ x: 0, y: 0 });
